...
module.exports = function assertRecordTests(ES, test) {
	test('Property Descriptor', function (t) {
		...
		forEach(v.nonUndefinedPrimitives, function (primitive) {
			t['throws'](
				function () {
					assertRecord(ES, record, 'arg', primitive);
				},
				TypeError,
		...
		t['throws'](
			function () {
				assertRecord(ES, record, 'arg', {invalid: true});
			},
			TypeError,
		...
		t.doesNotThrow(
			function () {
				assertRecord(ES, record, 'arg', v.accessorDescriptor());
			},
		...
		t.doesNotThrow(
			function () {
				assertRecord(ES, record, 'arg', v.mutatorDescriptor());
			},
		...
		t.doesNotThrow(
			function () {
				assertRecord(ES, record, 'arg', v.dataDescriptor());
			},
		...
		t.doesNotThrow(
			function () {
				assertRecord(ES, record, 'arg', v.genericDescriptor());
			},
		...
		t['throws'](
			function () {
				assertRecord(ES, record, 'arg', v.bothDescriptor());
			},
			TypeError,
